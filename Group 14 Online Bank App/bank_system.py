...
class BankSystem(object):
    ...
    def transferMoney(self):
            ...
            tfwn.configure(bg="red")
            fr1=tk.Frame(tfwn,bg="blue")
            l_title=tk.Message(tfwn,text="Zenith Bank PLC",relief="raised",width=2000,padx=600,pady=0,fg="black",bg="white",justify="center",anchor="center")
    ...
    def update_customer_name(self,sender):
        ...
        ndwn.configure(bg="red")
        fr1=tk.Frame(ndwn,bg="blue")
        l_title=tk.Message(ndwn,text="Zenith Bank PLC",relief="raised",width=2000,padx=600,pady=0,fg="black",bg="white",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
    ...
    def update_customer_address(self,sender):
        ...
        nawn.configure(bg="red")
        fr1=tk.Frame(nawn,bg="blue")
        l_title=tk.Message(nawn,text="Zenith Bank PLC",relief="raised",width=2000,padx=600,pady=0,fg="black",bg="white",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
    ...
    def run_account_options(self,sender,admin):
        ...
        cawn.configure(bg="red")
        fr1=tk.Frame(cawn,bg="blue")
        l_title=tk.Message(cawn,text="Zenith Bank PLC",relief="raised",width=2000,padx=600,pady=0,fg="black",bg="white",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
    ...
    def delete_customer(self,admin_obj):
        ...
        if admin_obj.has_full_admin_right():
            ...
            dcwn.configure(bg="red")
            fr1=tk.Frame(dcwn,bg="blue")
            l_title=tk.Message(dcwn,text="Zenith bank PLC",relief="raised",width=2000,padx=600,pady=0,fg="black",bg="white",justify="center",anchor="center")
            l_title.config(font=("Courier","50","bold"))
            l_title.pack(side="top")
...
#         messagebox.showinfo("Login Succesfull")
    ...
    def run_admin_options(self,admin_obj):
        ...
        opwn.configure(bg="red")
        fr1=tk.Frame(opwn,bg="blue")
        l_title=tk.Message(opwn,text="Zenith Bank PLC",relief="raised",width=2000,padx=600,pady=0,fg="black",bg="white",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
    ...
    def login(self,master):
        ...
        l_title=tk.Message(crwn,text="Zenith Bank PLC",relief="raised",width=2000,padx=600,pady=0,fg="black",bg="white",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
...
# Function for Calling the main menu
    def Main_Menu(self):
        ...
        rootwn.title("Zenith Bank PLC")
        rootwn.configure(background='red')
        fr1=tk.Frame(rootwn)
        fr1.pack(side="top")
        l_title=tk.Message(text="Zenith Bank PLC",relief="raised",width=2000,padx=600,pady=0,fg="black",bg="white",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
